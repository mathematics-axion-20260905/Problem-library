...
export async function fetchScientificObjectTransfer(transferId: string): Promise<Required<Pick<ScientificObjectTransferRecord, "transferId" | "payload">> & ScientificObjectTransferRecord> {
